...
SECRET_KEY = 'django-insecure--$hfo3m1$$ji%rb&r^kbqd#-#o2r_^6v3x!w)g$%mt#l+*k=v('
...
# This is where your app's static files are located
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'timetracker', 'static'),
]
